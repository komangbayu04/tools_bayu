...
export interface MeetingAnalysis {
  ...
  date: string           // ISO date of when it was analyzed
  summary: string        // 2-3 sentence overview of the meeting
  tasks: ExtractedTask[] // things Bayu needs to do
  watchPoints: string[]  // things to monitor / keep an eye on
  improvements: string[] // things to fix or improve
  savedAt: number
}
